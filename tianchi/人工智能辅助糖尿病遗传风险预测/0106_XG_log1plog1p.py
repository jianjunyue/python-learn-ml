...
clf.fit(X, Y)
print("---3----")
pred= np.expm1(np.expm1(clf.predict(test)))
pred_df=pd.DataFrame()
pred_df["pred"]=pred

pred_df.to_csv('/Users/jianjun.yue/PycharmGItHub/data/人工智能辅助糖尿病遗传风险预测/sub_0106_XG_log1plog1p.csv',header=False, index=False, float_format='%.3f')
