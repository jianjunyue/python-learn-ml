...
print("---2----")
clf.fit(X, Y)
FeatureImportances=pd.Series(clf.booster().get_fscore()).sort_values(ascending=False)
...
pred_df.to_csv('/Users/jianjun.yue/PycharmGItHub/data/人工智能辅助糖尿病遗传风险预测/sub_0107_XG_去掉负效果特征.csv',header=False, index=False, float_format='%.3f')
