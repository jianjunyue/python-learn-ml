...
importance = xgb1.booster().get_fscore()
importance=list(importance.items())
print(type(importance))
print("---importance----")
df_importance = pd.DataFrame(importance, columns=['feature', 'fscore'])
df_importance=df_importance.sort_values(by='fscore',ascending=False)
print(df_importance.head(10))
df_importance.to_csv('/Users/jianjun.yue/PycharmGItHub/data/智能制造质量预测/feat_imp.csv', index=False)
