...
ACCESS_KEY = "94094a55-e0524a27-e1f1cb38-d9666"
SECRET_KEY = "5ad92265-bf8e8dae-f831a7f8-92916"
...
def createSign(pParams, method, host_url, request_path, secret_key):
    printGet(pParams, method, host_url, request_path, secret_key)
...
def printGet(pParams, method, host_url, request_path, secret_key):
    print("pParams:")
    print(pParams)
    print("method:")
    print(method)
