...
df_quantity = pd.read_csv('/Users/jianjun.yue/PycharmGItHub/data/智能制造质量预测/特征重要性_SelectKBest.csv',header=0,encoding='utf-8')
df_quantity=df_quantity[df_quantity["value"]>1]
