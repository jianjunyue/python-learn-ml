...
# load data
data_root = "/Users/jianjun.yue/PycharmGItHub/data/国内比赛/腾讯移动App广告转化率预估"
print("%s/train.csv"%data_root)
dfTrain = pd.read_csv("%s/part/train_part.csv"%data_root)
dfTest = pd.read_csv("%s/part/test_part.csv"%data_root)
